...
# Addition by jackson. Constructs a lighter resnet model to be trained as feature extractor.
def resnet18_baseline(pretrained=False):
   """Constructs a modified ResNet-18 model. 
   Args:
      pretrained (bool): If True, does nothing in this version.
   """

   return ResNet_Baseline(Bottleneck_Baseline, [2,2,2,2])
